  ...
  return (
    <header className="text-gray-400 body-font shadow-lg">
      <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
        ...
        <button
          className="inline-flex items-center bg-blue-700 border-0 py-2 px-4 focus:outline-none hover:bg-red-700 rounded text-white mt-4 md:mt-0 transition-colors duration-150 text-sm md:text-base"
          >
         YouTube
         <svg
         fill="none"
